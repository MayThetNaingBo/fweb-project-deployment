...
export default function AdminEventList() {
    ...
    useEffect(() => {
        fetch("http://192.168.18.18:5050/api/admin/events")
            .then((res) => res.json())
    ...
    const handleDelete = async () => {
        ...
        try {
            await fetch(
                `http://192.168.18.18:5/api/admin/delete/events/${eventToDelete}`,
                {
                    method: "DELETE",
                }
            );
                ...
                {filteredEvents.map((event) => (
                    ...
                    >
                        <div onClick={() => handleCardClick(event._id)}>
                            ...
                            <img
                                src={event.image || "/assets/NoImage.jpg"} // Show default image if none provided
                                alt={event.title}
