    ...
    useEffect(() => {
        fetch("http://localhost:5050/api/admin/members")
            ...
            .then((data) => {
                ...
                const uniqueSchools = ["None", ...new Set(data.map((member) => member.school))];
...
<div className="search-bar mb-3 d-flex align-items-center"> {/* Flex container */}
    <input
        type="text"
        className="search-input me-3" // Added 'me-3' for spacing between elements
